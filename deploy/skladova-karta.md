...
3. Dva listy ve šabloně (`Strana 1`, `Strana 2`) — stejný layout (list 2 = clone listu 1 při údržbě šablony, ne kopírování stylů v PHP). Deník: max 40+40 záznamů; delší se ořízne.
